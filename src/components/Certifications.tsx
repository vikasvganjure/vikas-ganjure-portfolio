      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-3 text-slate-600 dark:text-zinc-400 text-sm sm:text-base">
            Continuous skill validation across programming, databases, cloud computing, and industry analytics.
          </p>
        </div>
          ...
          {certifications.map((cert) => (
            ...
            >
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors mb-2">
                  {cert.title}
                </h3>
